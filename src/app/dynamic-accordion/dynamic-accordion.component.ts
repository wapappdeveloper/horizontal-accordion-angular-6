...
@Component({
  ...
  animations: [
    trigger('menuSlider', [
      state('open', style({
        width: '266px',//Please add the accordionAnimationWidth 
      })),
      state('close', style({
...
export class DynamicAccordionComponent implements OnInit {
  ...
  defaultParam: any = {
    ...
    accordionData: [
      { tabName: 'Tab Name 1', id: 'tab1', data: this.string1, status: false },
      { tabName: 'Tab Name 2', id: 'tab2', data: this.string2, status: false },
      { tabName: 'Tab Name 3', id: 'tab3', data: this.string2, status: true },
      { tabName: 'Tab Name 4', id: 'tab4', data: this.string1, status: false },
      { tabName: 'Tab Name 5', id: 'tab5', data: this.string2, status: false },
      { tabName: 'Tab Name 6', id: 'tab6', data: this.string1, status: false },
      { tabName: 'Tab Name 1', id: 'tab7', data: this.string1, status: false },
      { tabName: 'Tab Name 2', id: 'tab8', data: this.string2, status: false },
      { tabName: 'Tab Name 3', id: 'tab9', data: this.string2, status: false },
      { tabName: 'Tab Name 4', id: 'tab10', data: this.string1, status: false },
      { tabName: 'Tab Name 5', id: 'tab11', data: this.string2, status: false },
      { tabName: 'Tab Name 6', id: 'tab12', data: this.string1, status: false }
    ],
    checkBox: true,
    checkBoxTop: 300,
    checkBoxLeft: 4
